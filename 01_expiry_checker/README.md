...
🎯 Current Focus
    ...
    Date Logic: Handling time-based calculations with Python's datetime module (e.g., calculating days until expiry).

    Data Persistence: Learning how to store, commit, and fetch data from a local .db file.
