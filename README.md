...
| :--- | :--- | :--- |
| **01_expiry_checker** | Expiry Date Tracker | SQLite Databases & Datetime logic |
| **02_password_evaluation** | Password Evaluator | String analysis & Security basics |
| **03_number_guessing** | Guessing Game | Game Loops & User Input validation |
| **04_grade_list** | Grade Calculator | Math operations & Exception handling |
